...
import  Pidev1.AjouterEventsController;
           ...
           name.setStyle(" -fx-font : 34px Georgia ;");
            ...
            GetData.path = a.getImg();
                ...
                AjouterEventsController ae = loader.getController();
                   ...
                   Events ev=se.getOneByName(a.getNameEv());
                   ae.id=ev.getId_event();
...
//            Button btnaffiche = new Button("Affichage");
    ...
    private void reserver(ActionEvent event) throws IOException {
        ...
        Parent rootNode = fxmlLoader.load(getClass().getResource("AjouterReservation.fxml"));
       // logger.trace("stage loaded");
 spe.getScene().setRoot(rootNode);
